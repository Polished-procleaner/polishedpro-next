...
export default function SectionForm() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await fetch('https://hook.us1.make.com/1wsap6a9eiocgulf7rlij660a8ah1kis', {
                method: 'POST',
                headers: {
                ...
                <div className="bg-white p-10 rounded-3xl shadow-lg border border-gray-200">
                    ...
                    {service === "residential" && (
                        <div className="mb-6 space-y-4">
                            <div>
                                <label htmlFor="residentialType" className="block font-semibold mb-2">
                            ...
                            <div className="grid md:grid-cols-2 gap-4">
                                ...
                                <div>
                                    <label htmlFor="squareFeetRes" className="block font-semibold mb-2">
                                        Square Feet
                                    </label>
                                    <input
                                        type="number"
                    ...
                    {service === "commercial" && (
                        <div className="mb-6 space-y-4">
                            <div>
                                <label htmlFor="commercialType" className="block font-semibold mb-2">
                            ...
                            <div>
                                <label htmlFor="squareFeetCom" className="block font-semibold mb-2">
                                    Square Feet
                                </label>
                                <input
                                    type="number"
                    ...
                    {service === "specialized" && (
                        <div className="mb-6">
                            <label htmlFor="specializedType" className="block font-semibold mb-2">
