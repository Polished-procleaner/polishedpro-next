  ...
  const items = [
    {
      ...
      description: "We use eco-friendly products to ensure that our cleaning services are environmentally responsible.",
      icon: <FaUsers className="size-6" />,
    },
    {
      title: "Premium 5-Star Care",
      description: "Our consistently high ratings reflect our commitment to exceeding expectations on every single job.",
      icon: <FaStar className="size-6" />,
    },
    {
      title: "Personal Relationships",
      description: "We believe in building lasting relationships with our clients based on trust, reliability, and exceptional service.",
      icon: <FaHandshake className="size-6" />,
    },
    {
      title: "Quick Response",
      description: "Need cleaning on short notice? We're known for our flexibility and ability to accommodate urgent requests.",
    ...
    >
      ...
      >
        ...
        <p className="text-gray-500 max-w-xl text-pretty italic leading-relaxed drop-shadow-lg">
          We are a team of passionate professionals dedicated to delivering exceptional cleaning services. Our commitment to quality and customer satisfaction is unwavering.
        </p>
      </motion.div>
      <motion.div
        initial="hidden"
    ...
    <>
      <section className="relative flex items-center min-h-[calc(100vh-120px)] overflow-hidden">
        ...
        <Container
          ...
          className="flex flex-col md:flex-row items-center justify-between gap-8 py-16 md:py-0"
        >
          <motion.div
            initial="hidden"
            whileInView="visible"
          ...
          >
            ...
            <p className="text-xs text-white text-center">
              ...
              <a href="/privacy-policy.pdf" target="_blank" className="underline">Privacy Policy</a>.
            </p>
          </motion.div>
        </Container>
      </section>
