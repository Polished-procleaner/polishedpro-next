                ...
                <div className="mx-auto max-w-6xl px-6">
                    ...
                    <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-4">
                        <article className="group relative overflow-hidden rounded-3xl border border-gray-200 bg-white p-8 shadow-md transition hover:-translate-y-1">
                            ...
                            <h3 className="font-display text-lg font-semibold text-gray-900">Call or Text</h3>
                        ...
                        <article className="group relative overflow-hidden rounded-3xl border border-gray-200 bg-white p-8 shadow-md transition hover:-translate-y-1">
                            ...
                            <h3 className="font-display text-lg font-semibold text-gray-900">Email Us</h3>
                            <p className="mt-2 text-gray-600">
                        ...
                        <article className="group relative overflow-hidden rounded-3xl border border-gray-200 bg-white p-8 shadow-md transition hover:-translate-y-1">
                            ...
                            <h3 className="font-display text-lg font-semibold text-gray-900">Social Media</h3>
                            <p className="mt-2 text-gray-600">
                        ...
                        <article className="group relative overflow-hidden rounded-3xl border border-gray-200 bg-white p-8 shadow-md transition hover:-translate-y-1">
                            ...
                            <h3 className="font-display text-lg font-semibold text-gray-900">Emergency Service</h3>
                            <p className="mt-2 text-gray-600">
            ...
            <section className="bg-white py-20">
                <div className="mx-auto max-w-6xl px-6">
                    ...
                    <article className="mx-auto max-w-3xl rounded-3xl border border-gray-200 bg-white p-8 text-center shadow-md">
                        ...
                        <h3 className="font-display text-lg font-semibold text-gray-900">Local Service Area</h3>
                        <p className="mt-2 text-gray-600">
